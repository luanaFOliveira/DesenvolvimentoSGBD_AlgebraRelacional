...
public class FormFrameMin extends JFrame implements ActionListener{
	 ...
	 * Create the frame.
	 */
	public FormFrameMin(Object cell, List<Cell> cells) {
	...
	public void executeOperation(String column) {
		...
		Operator operator = new MinOperator(parentCell.getData(),parentCell.getSourceTableName(column),column);
	    operator.open();
