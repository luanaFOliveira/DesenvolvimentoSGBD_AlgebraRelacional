...
public class FormFrameProdutoCartesiano extends JFrame implements ActionListener {
	...
	private JTextField tabela1;
	private JTextField tabela2;
	
	public static void main(Object cell, List<Cell> cells,mxGraph graph) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormFrameProdutoCartesiano frame = new FormFrameProdutoCartesiano(cell, cells,graph);
	...
	public FormFrameProdutoCartesiano(Object cell, List<Cell> cells,mxGraph graph) {
	...
	private void initializeGUI() {
		...
		nomeTabela1 = parentCell1.getName();
	
		nomeTabela2 = parentCell2.getName();
		...
		tabela1 = new JTextField();
		tabela1.setColumns(10);
		
		tabela2 = new JTextField();
		tabela2.setColumns(10);
		
		tabela1.setText(nomeTabela1);
		tabela2.setText(nomeTabela2);
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(tabela1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(26)
					.addComponent(lblNewLabel_2, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(tabela2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addGap(30)
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnPronto) {
			executeOperation();
	        graph.getModel().setValue(jCell,nomeTabela1 + " X " + nomeTabela2);
