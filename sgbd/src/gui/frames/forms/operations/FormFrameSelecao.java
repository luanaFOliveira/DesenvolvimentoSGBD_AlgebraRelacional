...
public class FormFrameSelecao extends JFrame implements ActionListener {
	...
	public static void main(Object cell, List<Cell> cells,mxGraph graph) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FormFrameSelecao frame = new FormFrameSelecao(cell, cells,graph);
	...
	public FormFrameSelecao(Object cell, List<Cell> cells,mxGraph graph) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == btnReady) {
	        ...
	        graph.getModel().setValue(jCell,"σ  "+ comboBoxColumns.getSelectedItem().toString()+" "+ comboBoxOp.getSelectedItem().toString()+" "+ textField.getText());
		}
