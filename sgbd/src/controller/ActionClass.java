...
public class ActionClass extends JFrame implements ActionListener, MouseListener, KeyListener {
	...
	private java.awt.Cursor graphDefaultCursor;
	private Boolean selectMultipleCellsBool =false;
	...
	private void initGUI() {
		...
		graphDefaultCursor = graphComponent.getCursor();
